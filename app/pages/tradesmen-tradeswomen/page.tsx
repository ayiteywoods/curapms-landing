...
export default function TradesmenTradeswomenPage() {
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            ...
            <h1 className="text-4xl font-bold leading-tight text-slate-900 lg:text-5xl">
              Connect with Skilled Tradesmen & Tradeswomen
            </h1>

            {/* Paragraph */}
            <p className="text-lg leading-relaxed text-slate-600">
              Access a network of verified trades professionals ready to handle your property maintenance needs. From plumbing and electrical work to carpentry and HVAC, find the right skilled professional for every job.
            </p>
          ...
          >
            <div className="relative h-[500px] w-full">
              <Image
                src="/trade1.jpg"
                alt="Tradesmen and tradeswomen illustration"
                fill
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          ...
          >
            <h2 className="text-3xl font-bold text-slate-900">
              Streamlined Service Provider Management
            </h2>
            <p className="text-lg leading-relaxed text-slate-600">
              Manage all your trades professionals in one centralized platform. Track work history, ratings, and availability. Schedule jobs, communicate directly, and ensure quality work with our comprehensive management tools.
            </p>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Book services with just a few clicks</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckIcon className="mt-1 h-5 w-5 flex-shrink-0 text-green-500" />
                <div>
                  <h3 className="font-semibold text-slate-900">Rating System</h3>
                  <p className="text-slate-600">See reviews and ratings from other property managers</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CheckIcon className="mt-1 h-5 w-5 flex-shrink-0 text-green-500" />
                <div>
                  ...
                  <p className="text-slate-600">Track all completed jobs and invoices</p>
                </div>
              </div>
            </div>
          </div>
